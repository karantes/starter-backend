...
public class DateConverter {
	...
	/**
	 * Transforma uma string com o formato passado por parametro do LocalDate informado
	 * 
	 * @param date
	 * @param formato
	 * @return
	...
	/**
	 * Transforma uma string com o formato passado por parametro do LocalDateTime informado
	 * 
	 * @param date
	 * @param formato
	 * @return
	...
	/**
	 * Transforma uma string com o formato passado por parametro do Calendar informado
	 * 
	 * @param calendar
	 * @param formato
	 * @return
	...
	public static Date stringToDate(String data, String formato) {
		try {
			...
			System.err.println(classe + " | " + metodo + " | " + e.getStackTrace()[0].getLineNumber() + " | " + e.getMessage());
			return null;
		}
